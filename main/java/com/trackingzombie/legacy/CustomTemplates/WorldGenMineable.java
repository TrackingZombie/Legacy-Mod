...
public class WorldGenMineable extends WorldGenerator 
{
    ...
    public WorldGenMineable(IBlockState block, int veinSize, Block[] generateIn, Block[] generateNear, int generateDistance)
    {
        this.oreBlock = block;
    ...
    public WorldGenMineable(IBlockState block, int veinSize)
    {
        this(block, veinSize, new Block[]{Blocks.stone});
    }
    
    public WorldGenMineable(IBlockState block, int veinSize, Block[] generateIn)
    {
