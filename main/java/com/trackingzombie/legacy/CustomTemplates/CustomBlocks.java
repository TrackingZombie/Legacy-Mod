...
public class CustomBlocks extends Block
{
	...
	public CustomBlocks(Material material, String name, float hardness, float resistance, HarvestToolEnum harvesttool, HarvestLevelEnum harvestlevel, CreativeTabs creativetab, int dropamountmax) 
	{ 
		super(material);
	...
	public void RegisterRenderer(String modelName)
	{
		...
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(Item.getItemFromBlock(this), 0, new ModelResourceLocation(Reference.MODID+":"+modelName, "inventory"));
	}		
